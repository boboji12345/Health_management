...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectClick(){
            ...
            window.location="selectteacherknowledgesInfoByTname?name="+name;
        }

        function godetailById(id) {
            window.location="goteacherknowledgedetailById?id="+id;
        }
                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="active"> <a href='${ctx}/admin/teacherknowledgesmana'>防控知识查看</a> </li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-has-subnav">
