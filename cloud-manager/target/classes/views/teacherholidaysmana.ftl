...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteById(aid){
            if(confirm("是否删除"))
                window.location="${ctx}/admin/deleteTeacherRholidaysInfoById?Id="+aid;
        }
        ...
        function deleteAll(){
            if(confirm("确定要批量删除吗？")){
                ...
                window.location="${ctx}/admin/deleteTeacherRholidaysInfoById2?Id="+endids;
            }
        }

        function selectClick(){
            var name = encodeURI(encodeURI($("#inputName").val()));
            window.location="selectTeacherRholidaysInfo?name="+name;
        }
        ...
        function update() {
            ...
            $.ajax({
                url:"${ctx}/admin/upTeacherHolidaysInfo",
                type:"get",
                data : {
                    id: id,
                    rntitle: rntitle
        ...
        function update1() {
            ...
            $.ajax({
                url:"${ctx}/admin/upTeacherHolidaysInfo1",
                type:"get",
                data : {
                    id: id,
                    rntitle: rntitle
                ...
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                <li class="active"> <a href='${ctx}/admin/teacherholidaysmana'>学生休假管理</a> </li>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th class="textalign" style="width: 300px">操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <#if admininfo??>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        ...
                                        <@fpage.fpage page=admininfo.page pagesize=admininfo.pagesize totalpages=admininfo.totalpages totalrecords=admininfo.totalrecords
                                            url="teacherholidaysmana?key=${Request.selectName}" />
                                    </ul>
                                </nav>
