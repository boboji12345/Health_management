...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteById(aid){
            if(confirm("是否删除"))
                window.location="${ctx}/admin/deleteTypesInfoById?Id="+aid;
        }
        ...
        function deleteAll(){
            if(confirm("确定要批量删除吗？")){
                ...
                window.location="${ctx}/admin/deleteTypesInfoById2?Id="+endids;
            }
        }

        function selectClick(){
            var name = encodeURI(encodeURI($("#inputName").val()));
            window.location="selectTypesInfo?name="+name;
        }
        ...
        function updateInfo(aid){
            ...
            $.ajax({
                url:"${ctx}/admin/getTypesInfoById",
                type:"get",
                data:{id:aid},
                dataType:"json",
                success:function(data){
                    $("#uftname").val(data.obj["rtname"]);
                }
            });
        }
        ...
        function update() {
            ...
            $.ajax({
                url:"${ctx}/admin/upAdminTypesInfo",
                type:"get",
                data : {
                    tid: tid,
                    tname: tname,
        ...
        function save() {
            ...
            $.ajax({
                url:"${ctx}/admin/addAdminTypesInfo",
                type:"get",
                data : {
                    tname: tname,
                    timg: ""
                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="active"> <a href='${ctx}/admin/admintypesmana'>类型信息管理</a> </li>
            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 首页 —— 类型信息管理 </span>
                    </div>
...
<#include "admintypes_add.ftl">
<#include "admintypes_update.ftl">
