                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="col-sm-9" id="apattr" style="width:700px; height:40px;" placeholder="请输入所在位置">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="col-sm-9" id="aptemperature"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="col-sm-9" id="apuzhengjianhaoma"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="col-sm-9" id="aplaiyuan"
                        ...
                        <div class="form-group" style="margin-top: 5px;">
                            ...
                            <div class="col-sm-10">
                                <label class="radio" style="margin-left: 15px;">
                                    <input type="radio" name="azhuangkuang" value="非常健康" checked="checked">非常健康</label>
                                <label class="radio" style="margin-left: 15px;">
                                    <input type="radio" name="azhuangkuang" value="良好">良好</label>
                                <label class="radio" style="margin-left: 15px;">
                                    <input type="radio" name="azhuangkuang" value="身体不适">身体不适</label>
                                <label class="radio" style="margin-left: 15px;">
                                    <input type="radio" name="azhuangkuang" value="感冒发烧">感冒发烧</label>
                            </div>
                        </div>
