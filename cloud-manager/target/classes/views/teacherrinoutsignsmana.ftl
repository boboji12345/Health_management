...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectClick(){
            ...
            window.location="selectTeacherRinoutsignsInfo?name="+name;
        }
                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="active"> <a href='${ctx}/admin/teacherrinoutsignsmana'>进出登记管理</a> </li>
            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 首页 —— 进出登记信息查看 </span>
                    </div>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        ...
                                        <@fpage.fpage page=admininfo.page pagesize=admininfo.pagesize totalpages=admininfo.totalpages totalrecords=admininfo.totalrecords
                                            url="teacherrinoutsignsmana?key=${Request.selectName}" />
                                    </ul>
                                </nav>
