...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteById(aid){
            if(confirm("是否删除"))
                window.location="${ctx}/admin/deleteknowledgesInfoById?Id="+aid;
        }
        ...
        function deleteAll(){
            if(confirm("确定要批量删除吗？")){
                ...
                window.location="${ctx}/admin/deleteknowledgesInfoById2?Id="+endids;
            }
        }

        function selectClick(){
            var name = encodeURI(encodeURI($("#inputName").val()));
            window.location="selectknowledgesInfoByTname?name="+name;
        }
        ...
        function updateInfo(aid){
            ...
            $.ajax({
                url:"${ctx}/admin/getRknowledgesInfoById",
                type:"get",
                data:{id:aid},
                dataType:"json",
                success:function(data){
                    $("#uname").val(data.obj["rktitle"]);
                    $("#uinstroduces").val(data.obj["rkinstroduces"]);

                    var ue = UE.getEditor('myUpEditor');
                    ue.addListener("ready", function () {
                        ue.setContent(data.obj["rkcont"]);
                    });
                    ue.setContent(data.obj["rkcont"]);
                }
            });
        ...
        function update() {
            ...
            if(isEmpty(rntitle)){
                alert("疫情防控知识信息不能为空，请确认一下！");
                return;
            }

            $.ajax({
                url:"${ctx}/admin/upAdminRknowledgesInfo",
                type:"get",
                data : {
                    id: id,
                    rntitle: rntitle,
        ...
        function save() {
            ...
            $.ajax({
                url:"${ctx}/admin/addAdminRknowledgesInfo",
                type:"get",
                data : {
                    rntitle: rntitle,
                    rinstroduces: rinstroduces,
                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="active"> <a href='${ctx}/admin/adminknowledgesmana'>防控知识管理</a> </li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-has-subnav">
            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 首页 —— 疫情防控知识管理 </span>
                    </div>
