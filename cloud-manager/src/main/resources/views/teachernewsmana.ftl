...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectClick(){
            ...
            window.location="selectTeacherUserNewsInfoByTname?name="+name;
        }
                ...
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                <li class="active"> <a href='${ctx}/admin/teachernewsmana'>新闻信息查看</a> </li>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        ...
                                        <@fpage.fpage page=admininfo.page pagesize=admininfo.pagesize totalpages=admininfo.totalpages totalrecords=admininfo.totalrecords
                                            url="teachernewsmana?key=${Request.selectName}" />
                                    </ul>
                                </nav>
