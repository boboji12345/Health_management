...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectClick(){
            ...
            window.location="${ctx}/admin/selectUsersByFlagInfoByFuzzyquery?name="+name;
        }
                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="active"> <a href='${ctx}/admin/adminclockedusersmana'>当日已打卡学生</a> </li>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        ...
                                        <@fpage.fpage page=memberusers.page pagesize=memberusers.pagesize totalpages=memberusers.totalpages totalrecords=memberusers.totalrecords
                                            url="adminclockedusersmana?key=${Request.selectName}" />
                                    </ul>
                                </nav>
